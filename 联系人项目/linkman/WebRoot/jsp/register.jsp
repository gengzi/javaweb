...
<body>
	<center>
		...
		<form action="<%=path%>/LinkManServlet" method="post">
			...
			<!--登陆 method =2  -->
			用户名：<input type="text" name="username" id="name" onblur="nameOnblur()"><div id="nameid"></div><br>
			 密 码： <input type="password" name="password" id="password" onblur="pwOnblur()"/><div id="passwordid"></div><br> 
